...
class RequestValidation
{
    ...
    protected static $errors = [
        ...
        'equals' => 'The :attribute must match the :policy field',
    ];
    ...
    protected static function minLength($field, $value, $policy): bool
    {
        return strlen($value) >= $policy;
    }
    ...
    protected static function equals($field, $value, $policy): bool
    {
        if (!isset($_REQUEST[$policy])) {
            return false;
        }
        
        return $value === $_REQUEST[$policy];
    }
}
